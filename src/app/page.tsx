      ...
      <main className="bg-gray-10 flex-1 flex flex-col items-center justify-center  px-10 py-8">
        <div className="max-w-[90%] w-full mx-auto p-12 flex flex-col items-center justify-center text-center">
          ...
          <div className="px-10 py-10 rounded-xl bg-white p-12 shadow-2xl border flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm md:text-base lg:text-lg text-[#B80050] font-medium">
              Our mission is to empower future healthcare professionals by delivering outstanding technical support, innovative simulation-based learning opportunities, and safe, realistic environments that mirror the evolving demands of clinical practice. Through our commitment to technical excellence, collaborative practice, and innovation—including the integration of advanced patient simulators, clinical technologies, and virtual learning platforms—we aim to enhance the applied learning experience for every student.
            </p><br></br>
            <p className="text-sm md:text-base lg:text-lg text-[#B80050] font-medium">
              We strive to create inclusive, high quality, and future focused learning environments where students can develop critical thinking, clinical decision making, and patient centred skills before entering real world healthcare settings. By continuously advancing our facilities, embracing innovative technologies, and supporting research, teaching, and professional practice, we contribute to the development of confident, competent, and placement ready healthcare practitioners.
            </p>
          </div>
        </div>
      </main>
